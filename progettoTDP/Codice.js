function creaSezione(titoloTesto, descrizioneTesto) {
    ...
    contenitoreCard.classList.add("contenitoreCard");
...
function creaCard(sezione, titoloTesto, immagine, descrizione) {
    let contenitore = sezione.querySelector(".contenitoreCard");
...
function apriSegnaletica() {
    ...
    creaCard(sezionePericoli, "Attraversamento pedonale", "img/attraversamentoPedonale.webp", "Segnale che indica un attraversamento riservato ai pedoni.");
...
let quiz = [
    {
        domanda: "Cosa indica il segnale STOP?",
        risposte: ["Fermarsi completamente", "Rallentare", "Dare precedenza", "Accelerare"],
        corretta: "Fermarsi completamente"
    },
    {
        domanda: "Cosa indica il segnale di divieto di sorpasso?",
        risposte: ["Sorpasso libero", "Sorpasso vietato", "Solo camion", "Solo bici"],
        corretta: "Sorpasso vietato"
    },
    {
        domanda: "Cosa bisogna fare con il semaforo rosso?",
        risposte: ["Accelerare", "Fermarsi", "Passare piano", "Suonare il clacson"],
        corretta: "Fermarsi"
    },
    {
        domanda: "A cosa serve la cintura di sicurezza?",
        risposte: ["Decorazione", "Sicurezza in caso di incidente", "Velocità", "Navigazione"],
        corretta: "Sicurezza in caso di incidente"
    },
    {
        domanda: "Cosa indica il segnale di precedenza?",
        risposte: ["Passare sempre", "Dare priorità ad altri veicoli", "Accelerare", "Fermarsi sempre"],
        corretta: "Dare priorità ad altri veicoli"
    }
];
...
function mostraRisultato() {
    ...
    if (punteggio >= 4) {
        titolo.innerText = "Bravo! Hai passato il quiz 🚗";
    } else {
        titolo.innerText = "Devi ripassare un po' 😅";
    }

    let score = document.createElement("p");
    score.innerText = "Punteggio: " + punteggio + " / " + quiz.length;

    let btn = document.createElement("button");
    btn.innerText = "Torna alla Home";
